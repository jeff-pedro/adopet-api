...
routes
  ...
  .post('/pets/:id/adoption', (req, res, next) => petsController.adopt(req, res, next))
  ...
  .put('/pets/:id/adoption/cancel',authorization, profile(['shelter']), (req, res, next) => petsController.cancelAdoption(req, res, next))
